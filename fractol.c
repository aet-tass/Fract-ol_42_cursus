...
/*   Updated: 2023/03/08 21:01:30 by aet-tass         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_error(void)
{
	...
	ft_putstr_fd("-------------------- // -----------------------\n", 2);
	ft_putstr_fd("Would u like to dazzle ur ", 2);
	ft_putstr_fd(" eyes by watching some fractals?\n", 2);
	ft_putstr_fd(" --> Then here is what you have to do :\n", 2);
	ft_putstr_fd("\n", 2);
	ft_putstr_fd("-> if u want to see Mandelbrot_set, ", 2);
	ft_putstr_fd("ur argument must be as bellow:\n", 2);
	ft_putstr_fd("      ./fractol 1\n", 2);
	ft_putstr_fd("-> if u want to see Julia, ", 2);
	ft_putstr_fd("ur args must be as bellow :\n", 2);
	ft_putstr_fd("      ./fractol 2 c_re c_img\n", 2);
	ft_putstr_fd(" Note That : -2 < c_re < 2 && -2 < c_img < 2\n", 2);
	ft_putstr_fd(" here is some famous julia_set's coordinates : ", 2);
	ft_putstr_fd(" -0.8 0.156 /  -0.4 0.6\n", 2);
	ft_putstr_fd("-> if u want to see Burning_ship_set, ", 2);
	ft_putstr_fd(" ur arguments must be as bellow:\n", 2);
